...
FINISH_NOTIFICATION_EMAIL_ADDRESS=""
NUM_CORES_TO_USE=5                                       # Should be slighly *below* total core count. If you use all, it will be a pain to anything on the machine while this runs. Leave 1 or 2 cores alone.
